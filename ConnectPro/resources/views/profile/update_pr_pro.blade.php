                ...
                <div class="mt-6">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="bio" rows="5"
                            ...
                            placeholder="Présentez-vous, votre parcours, vos compétences...">{{ old('bio', $user->bio) }}</textarea>
                    </div>
...
<script>
    // Liste des régions et villes du Maroc
    const regionsCities = {
    ...
    // Récupérer l'ancienne valeur de la ville (si erreur de validation)
    ...
    // Initialiser les villes au chargement de la page
