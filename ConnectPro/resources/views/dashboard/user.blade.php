...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <div class="flex items-center justify-between px-6 py-3">
            ...
            <div class="flex-1 max-w-2xl mx-6">
                <div class="flex items-center gap-2">
                    ...
                    {{-- Bouton de filtrage déplacé dans le header --}}
    ...
    <div class="flex pt-16">
        ...
        <aside class="fixed left-0 top-16 h-[calc(100vh-64px)] w-72 bg-white dark:bg-gray-800 shadow-2xl z-30 flex flex-col">
            ...
            <div class="p-5 border-b border-gray-200 dark:border-gray-700">
                <div class="flex flex-col items-center text-center">
                    ...
                    {{-- Bouton Modifier --}}
                    <a href="{{ route('profile.edit') }}" class="mt-3 w-full flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[#0A2647] dark:text-white bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition">
            ...
            <!-- Menu scrollable (Messages, Notifications, etc.) -->
        ...
        <main class="flex-1 ml-72 p-6">
            ...
            <!-- BARRE DE FILTRAGE CACHÉE / RÉVÉLABLE (Nom, Catégorie, Spécialité, Ville, Région) -->
            <div id="filterBar" class="filter-bar-hidden bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden border border-gray-200 dark:border-gray-700">
                <div class="px-4">
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-3">
                        <div>
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Nom</label>
                            <input type="text" placeholder="Nom du professionnel" class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-[#FFB703] focus:border-transparent outline-none">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Catégorie</label>
                            <select class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-[#FFB703] focus:border-transparent outline-none">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Ville" class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-[#FFB703] focus:border-transparent outline-none">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Région</label>
                            <input type="text" placeholder="Région" class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-[#FFB703] focus:border-transparent outline-none">
                        </div>
                    </div>
                    <div class="flex justify-between items-center mt-4 pt-3 border-t border-gray-100 dark:border-gray-700">
                        <button onclick="resetFilters()" class="text-xs text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 transition flex items-center gap-1">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <div id="postsFeed" class="space-y-5 max-h-[calc(100vh-300px)] overflow-y-auto pr-2 custom-scrollbar">
    ...
    <script>
        ...
        function applyFilters() {
            ...
            // Optionnel : fermer la barre après application
            // toggleFilterBar();
        }
        
        function resetFilters() {
            // Réinitialiser tous les champs de la barre de filtres
            const filterBar = document.getElementById('filterBar');
